...
export default function ServicesSection() {
  const services = [
    {
      name: "Box Braids Delicadas",
      description: "Proteção e estilo duradouro com técnicas suaves e femininas",
    ...
    },
    {
      ...
      description: "Volume e comprimento dos sonhos com fibras de alta qualidade",
      price: "A partir de R$ 200",
      duration: "5-7 horas",
      image: "/images/trabalho-4.jpeg",
      color: "from-studio-gold to-studio-terracotta",
      features: ["Fibras premium", "Resultado natural", "Máximo volume"],
    },
  ]
